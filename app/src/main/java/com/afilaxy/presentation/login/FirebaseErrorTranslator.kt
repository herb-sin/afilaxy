...
fun translateFirebaseError(error: String?): String {
    ...
    return when {
        ...
        error.contains("The password is invalid") -> "Email ou senha incorretos"
        ...
        error.contains("INVALID_LOGIN_CREDENTIALS") -> "Email ou senha incorretos"
        error.contains("The supplied auth credential is incorrect, malformed or has expired") -> "Email ou senha incorretos"
